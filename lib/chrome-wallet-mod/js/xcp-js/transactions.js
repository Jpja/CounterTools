...
function sendBroadcast(add_from, message, value, feefraction, transfee, mnemonic, feedbackdiv) {
	...
	bcTimeouts.push(setTimeout(prepareBroadcast_blockchaininfo, 2000, add_from,  message, value, feefraction, transfee, mnemonic, callback, feedbackdiv));
