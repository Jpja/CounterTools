...
function sendBTC(add_from, add_to, sendtotal, transfee, mnemonic, feedbackdiv) {
	...
	sendTimeouts.push(setTimeout(prepareSendBTC_bitpay, 1, add_from, add_to, sendtotal, transfee, mnemonic, feedbackdiv));
	sendTimeouts.push(setTimeout(prepareSendBTC_blockchaininfo, 2000, add_from, add_to, sendtotal, transfee, mnemonic, feedbackdiv));
